...
<ScaledImage
  ...
  alt="Sentry AI Code Review in action on a GitHub pull request"
/>

Sentry recently released AI Code Review, which adds AI-powered code review and test generation directly in your GitHub workflow. This feature gives you several new capabilities:
...
- Install and configure Sentry AI Code Review for automated PR review
...
## Setting Up Sentry AI Code Review
...
3. **Open a Pull Request**
   ...
   It also includes several other fixes throughout my project.
   ```

</Steps>

## Testing Sentry AI Code Review in Action

Now let's see Sentry AI Code Review in action by requesting a code review of our enhanced course creation feature.
...
<Steps>
  1. **Request an AI Code Review**
     ...
     Sentry AI Code Review will acknowledge your request and begin analyzing your code changes. The AI will review:
...
3. **Generate Comprehensive Tests**
   ...
   Sentry AI Code Review will analyze your course creation feature and generate tests covering:
...
AI-powered PR review with Sentry AI Code Review gives you a comprehensive approach to maintaining code quality and accelerating development. You can use it to:

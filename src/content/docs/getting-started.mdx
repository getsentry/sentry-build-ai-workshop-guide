...
Now we need to ensure that Sentry and Github are properly configured so that we can use Seer. This way Seer will have the full context of our code base and will be able to provide us with the best possible suggestions.
...
To be sure we'll double check our Project ➡️ Settings ➡️ Seer to confirm our repo is preset in the list.

<ScaledImage src="/assets/img/seer-project-settings.png" alt="Seer Settings" size={100} />

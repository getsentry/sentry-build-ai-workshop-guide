...
<ScaledImage
  src="/assets/img/m3-enroll-error.png"
  alt="Enroll Error"
  size={100}
/>
...
2. **Test Enrollment Tracing**
   ...
   <ScaledImage
     src="/assets/img/m3-trace-explorer-fe.png"
...
3. **Examine the Trace**
   ...
   <ScaledImage
     src="/assets/img/m3-trace-waterfall-fe.png"
     alt="Trace Waterfall"
   />
     ...
     try {
       ...
       await Sentry.startSpan(
         ...
         async (span) => {
           ...
           logger.info(
             logger.fmt`Processing enrollment request for course: ${courseId || 'undefined'}, user: ${userId || 'undefined'}`
           );
       ...
       logger.error(
         logger.fmt`Enrollment error for course ${req.body.courseId || 'undefined'}, user ${req.body.userId || 'undefined'}: ${error.message}`
       );
...
4. **Test Enrollment Tracing**
   ...
   <ScaledImage
     src="/assets/img/m3-trace-explorer-be.png"
...
5. **Examine the Trace**
   ...
   <ScaledImage
     src="/assets/img/m3-trace-waterfall-be.png"
     alt="Trace Waterfall"
   />
...
<ScaledImage
  src="/assets/img/m3-enroll-success.png"
  alt="Enroll Success"
  size={100}
/>

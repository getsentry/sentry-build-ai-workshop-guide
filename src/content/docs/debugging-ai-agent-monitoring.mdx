---
title: Understanding AI Performance with Agent Monitoring
...
- Custom instrumentation options when out of the box SDK support isn't available
...
5. **Viewing Tool Calls**
   ...
   Selecting the tools tab shows us statistics for the different tool calls that have been made. When we dive into any of these we'll be dropped into the Trace Explorer where we can query and search across all the traces in the environment.

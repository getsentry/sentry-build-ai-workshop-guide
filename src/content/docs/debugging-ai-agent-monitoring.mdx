...
4. **Review the Results in AI Agent Monitoring**
   ...
   <ScaledImage src="/assets/img/ai-agent-dashboard.png" alt="AI Agent Dashboard" size={75} /> 
...
5. **Review the Agent Trace View**
   ...
   <ScaledImage src="/assets/img/agent-span.png" alt="AI Agent Trace" size={75} />
...
6. **Review tool call spans**
   ...
   <ScaledImage src="/assets/img/tool-span.png" alt="Tool Call Span" size={75} />
...
7. **Explore the full trace waterfall**
    ...
    <ScaledImage src="/assets/img/full-trace-ai.png" alt="Full Trace" size={75} />
...
2. **Test the Course Builder functionality**
   ...
   <ScaledImage src="/assets/img/course-builder.png" alt="Course Builder" size={75} />
...
3. **Review the created course**
   ...
   <ScaledImage src="/assets/img/created-course.png" alt="Created Course" size={75} /> 
...
4. **Return to Insights > AI Agents **
    ...
    <ScaledImage src="/assets/img/updated-calls-agents.png" alt="Updated Calls" size={75} /> 
   
4. **Viewing Tool Calls**

...
<Steps>
  ...
  4. **Test Search Tracing**
     ...
     <ScaledImage src="/assets/img/m2-trace-explorer-fe.png" alt="Trace Explorer FE" size={100} />
  ...
  5. **Examine the Trace**
     ...
     <ScaledImage src="/assets/img/m2-trace-waterfall-fe.png" alt="Trace Waterfall" />
...
<Steps>
  ...
  4. **Test Search Tracing**
     ...
     <ScaledImage src="/assets/img/m2-trace-explorer-be.png" alt="Trace Explorer BE" size={100} />

  5. **Examine the Trace**

     Clicking into one of the spans will show you the trace waterfall where you can examine the properties of any of the spans submitted.

     <ScaledImage src="/assets/img/m2-trace-waterfall-be.png" alt="Trace Waterfall" />
...
<ScaledImage src="/assets/img/m2-search-success.png" alt="Search Fixed" size={100} />
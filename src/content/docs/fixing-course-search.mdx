...
Alternatively you can use the [mcp.sentry.dev](mcp.sentry.dev) web client for a simple way to configure and test the MCP server. From here you can authenticate with your Sentry organization and access a hosted MCP server for testing.

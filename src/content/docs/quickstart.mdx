...
<Steps>
  1. **Fork the repository**
     ...
     Go to [https://github.com/getsentry/sentry-academy-ai-workshop](https://github.com/getsentry/sentry-academy-ai-workshop) and click the "Fork" button in the top right. Then, clone your fork:
